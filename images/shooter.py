...
shooting_sound = mixer.Sound("laser-gun-shot-sound-future-sci-fi-lazer-wobble-chakongaudio-174883.mp3")
game_over_sound = mixer.Sound("nostro5-73932.mp3")


background_img = pygame.image.load("space_image")
background_img = pygame.transform.scale(background_img, (700, 700))
player_img = pygame.image.load("3d-rocket.png")
player_img = pygame.transform.scale(player_img, (50, 50))
enemy_img = pygame.image.load("ufo.png")
enemy_img = pygame.transform.scale(enemy_img, (50, 50))
enemy_img1 = pygame.image.load("ufo.png")
